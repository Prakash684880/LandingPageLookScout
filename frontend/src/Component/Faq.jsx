          ...
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                <div>
                  <h1 className="font-bold">Authentication Issues</h1>
                  <h3 className="text-base text-gray-400">
                    Lorem ipsum dolor sit amet consectetur adipisicing?
                  </h3>
                </div>

                <button className="text-blue-400 border hover:bg-blue-200 rounded shadow-sm px-2">
                  {" "}
                  New
                </button>
              </summary>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                ...
                <div className="flex gap-4">
                  <h2 className="text-gray-400 ">Updated Last Week</h2>
                  <svg
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                ...
                <div className="flex gap-4">
                  <h2 className="text-gray-400">Updated Today</h2>
                  <svg
                    className="size-5 shrink-0 transition duration-300 group-open:-rotate-180"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                ...
                <div className="flex gap-4">
                  <h2 className="text-gray-400">Updated 1 days ago</h2>
                  <svg
                    className="size-5 shrink-0 transition duration-300 group-open:-rotate-180"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                ...
                <div className="flex gap-4">
                  <h2 className="text-gray-400">Updated 2 days ago</h2>
                  <svg
                    className="size-5 shrink-0 transition duration-300 group-open:-rotate-180"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                ...
                <div className="flex gap-4">
                  <h2 className="text-gray-400">Updated 3 days ago</h2>
                  <svg
                    className="size-5 shrink-0 transition duration-300 group-open:-rotate-180"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 p-4 text-gray-900">
                ...
                <div className="flex gap-4">
                  <h2 className="text-gray-400">Updated 4 days ago</h2>
                  <svg
                    className="size-5 shrink-0 transition duration-300 group-open:-rotate-180"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
