    ...
    <div className="min-h-[60vh] bg-white lg:py-10 lg:px-6">
      ...
      <div className="max-w-full p-2 flex gap-2">
        <article className="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm">
          <div className="w-[60px] h-[60px] p-4 sm:p-6">
            <svg
              fill="#000000"
              height="50px"
              width="50px"
            ...
            >
              <g>
                <g>
                  <path
                    d="M480.156,224.157c-15.158,0-27.867,10.649-31.062,24.856h-85.89l-32.748-56.403l67.745-67.744
        ...
        <article className="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm">
          <div className="w-[60px] h-[60px] p-4 sm:p-6 text-white">
            <svg
              width="50px"
              height="50px"
              viewBox="0 0 24 24"
            ...
            >
              ...
              >
                <g id="Artboard" transform="translate(-74.000000, -195.000000)">
                  <g
                    id="Streaming"
                    transform="translate(74.000000, 195.000000)"
                  >
                    <rect
                      id="Rectangle"
                      x="0"
                    ...
                    ></rect>
                    <path
                      d="M8.46448,15.5354 C6.51186,13.5828 6.51186,10.417 8.46448,8.46436"
                      id="Path"
                      stroke="#0C0310"
                      strokeWidth="2"
                      strokeLinecap="round"
                    ></path>
                    <path
                      d="M5.63605,18.3637 C2.12133,14.8489 2.12133,9.15046 5.63605,5.63574"
                      id="Path"
                      stroke="#0C0310"
                      strokeWidth="2"
                      strokeLinecap="round"
                    ></path>
                    <path
                      d="M15.5355,8.42893 C17.4881,10.3816 17.4881,13.5474 15.5355,15.5"
                      id="Path"
                      stroke="#0C0310"
                      strokeWidth="2"
                      strokeLinecap="round"
                    ></path>
                    <path
                      d="M18.364,5.57188 C21.8787,9.0866 21.8787,14.7851 18.364,18.2998"
                      id="Path"
                      stroke="#0C0310"
                      strokeWidth="2"
                      strokeLinecap="round"
