    ...
    <section className="bg-white ">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto mb-8 max-w-[130vh] text-center lg:mb-16">
          ...
          <p className="text-center items-center justify-center text-slate-700 sm:text-xl ">
            organically grow the holistic world view of disruptive innovation
            via workplace diversity and empowowerment of people and great talent
            that truly rocks.
          </p>
        </div>

        <div className="grid gap-8 lg:gap-12 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {/* teams */}

          <div className="relative">
            <img
              className="mx-auto w-full h-auto rounded img-equal "
              src={team1img}
              alt="team1img"
            />

            <div className=" text-black ">
              <h3 className="text-2xl font-bold ">Morgan Dev</h3>
          ...
          <div className="relative">
            ...
            <div className=" text-black">
              <h3 className="text-2xl font-bold ">Richarlson</h3>
          ...
          <div className="relative">
            ...
            <div className=" text-black">
              <h3 className="text-2xl font-bold ">Andrew Steve</h3>
