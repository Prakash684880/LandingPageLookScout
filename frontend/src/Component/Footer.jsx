...
const Footer = () => {
  return (
    <div className="my-8 ">
      <div className="grid justify-between gap-14 mx-8 text-black sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {/* logo */}
        <div className="flex flex-col lg:max-w-[250px]">
          ...
          {/* Social media links */}
          <div>
            <ul className="flex mt-2 space-x-14 lg:space-x-2">
              <li>
                <a
                  href="#"
                ...
                >
                  <svg
                    className="w-10 h-10 inverted lg:w-6 lg:h-6"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
        ...
        <div className="flex px-2 mt-8 lg:mt-0">
          {/* products */}
          <div className="">
            <h1 className="pb-4 font-bold">Products</h1>
            <div>
              <ul className="flex flex-col justify-start">
                <li className="py-2">Feautures</li>
          ...
          <div className="ml-auto">
            <h1 className="pb-4 font-bold">Resources</h1>
            <div>
              <ul className="flex flex-col justify-start">
        ...
        <div className="flex px-2 mt-8 lg:mt-0">
          {/* choose why */}
          <div className="">
            <h1 className="pb-4 font-bold">Why Choose Us ?</h1>
            <div>
              <ul className="flex flex-col justify-start">
                <li className="py-2">Channels</li>
                <li className="py-2">Scale</li>
                <li className="py-2">Watch the Demo</li>
                <li className="py-2">Our Compensation</li>
              </ul>
            </div>
          </div>
